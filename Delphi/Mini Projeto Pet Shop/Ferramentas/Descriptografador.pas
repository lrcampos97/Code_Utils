...
type
  ...
  private
    ...
    function Descriptografar(sWord: String): String;
    function Criptografar(sWord: String): String;
  public
    { Public declarations }
  end;
...
function TfrmCriptografador.Criptografar(sWord: String): String;
begin
  //
end;

function TfrmCriptografador.Descriptografar(sWord: String): String;
begin
  //
end;
