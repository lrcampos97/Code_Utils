object frameFoto: TframeFoto
  ...
  object btnVisualizarFoto: TSpeedButton
    Left = 149
    Top = 226
    Width = 32
    Height = 32
    ...
    OnClick = btnVisualizarFotoClick
  end
  ...
  object dbimgCliente: TDBImage
    Left = 1
    Top = 23
    Width = 249
    Height = 200
    DataField = 'FOTOPESSOA'
  ...
  object edtCaminhoFoto: TEdit
    ...
    ParentFont = False
    TabOrder = 1
    Text = 'c:\desktop\lcampos\futebol.jpg'
  end
  object dlgOpenPic: TOpenPictureDialog
    FileName = 
      'C:\Users\Luiz Felipe Campos\Desktop\Luiz\Projeto Pet Shop\Imagen' +
      's\Img\161442316062.bmp'
    Left = 188
    Top = 47
  end
end
